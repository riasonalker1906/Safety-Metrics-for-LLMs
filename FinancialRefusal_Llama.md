From: https://ai.meta.com/llama/use-policy/
Prohibited Uses
...
From: https://huggingface.co/meta-llama/Llama-3.2-3B-Instruct/blob/main/README.md
Safety, Responsibility, and Prohibited Uses
From the Llama 3.2 Acceptable Use Policy:
We want everyone to use Llama 3.2 safely and responsibly. You agree you will not use, or allow others to use, Llama 3.2 to:
...
Interact with third party tools, models, or software designed to generate unlawful content or engage in unlawful or harmful conduct and/or represent that the outputs of such tools, models, or software are associated with Meta or Llama 3.2

From the Responsibility & Safety Section:
